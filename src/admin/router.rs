...
use super::{
    handlers::{
        ...
        get_update_config, list_client_keys, list_traces, poll_idc_login, poll_idc_relogin,
        ...
        stats_overview, stats_timeseries, trace_failure_stats, update_admin_key, update_api_key,
        update_client_key, update_credential, update_global_config, update_refresh_token,
    },
...
pub fn create_admin_router(state: AdminState) -> Router {
    ...
    let authenticated = Router::new()
        ...
        .route("/config/runtime", get(get_runtime_compatibility))
        .route(
            "/config/global",
